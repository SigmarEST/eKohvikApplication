...
class Reader extends _events2.default {
	...
	connect() {
		let mode = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : CONNECT_MODE_CARD;
	...
	authenticate(blockNumber, keyType, key) {
		var _this3 = this;

		let obsolete = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;
		return _asyncToGenerator(function* () {
	...
	read(blockNumber, length) {
		var _this4 = this;

		let blockSize = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 4;
		let packetSize = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 16;
		return _asyncToGenerator(function* () {
	...
	handle_Iso_14443_3_Tag() {
		...
		return _asyncToGenerator(function* () {
			...
			// APDU CMD: Get Data
			let packet = new Buffer([0xff, // Class
			0xca, // INS
